...
const Button = (props: Props) => {
  ...
  if (props.color === "white") {
    ...
    colorClasses =
      "bg-portfolio-lightGreen  text-black dark:hover:text-white border dark:bg-gray-900 dark:text-green-500 dark:hover:text-green-300 dark:hover:border-portfolio-snowWhite dark:border-green-500 dark:hover:border-green-300";
  }
