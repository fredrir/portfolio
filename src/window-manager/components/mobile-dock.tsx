...
export function MobileDock({ activeApp, onOpenApp, onGoHome }: Props) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] font-mono">
      <div className="mx-3 mb-3 rounded-2xl bg-background/70 border border-wm-border backdrop-blur-xl shadow-lg shadow-wm-shadow-soft">
        <div className="flex items-center justify-around h-14 px-2">
          ...
          >
            <div className="w-12 h-12 rounded-full bg-surface-raised border border-surface-strong flex items-center justify-center text-primary-bold shadow-md shadow-wm-shadow">
