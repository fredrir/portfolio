...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ds_xAuyJ.mjs");
...
var manifest = {
	"32acd23f426f29c3172a707333b8e9d6c331bdd3ae242f07b4cd945cec6318f0": {
		functionName: "recordVisit_createServerFn_handler",
		importer: () => import("./visitor-CX3F3OKg.mjs")
	},
	"3e44fc580f25301b5fc81d9c1d8c42d79e34f5a1d9e35f8dc102a5678c4016d2": {
		functionName: "getPageData_createServerFn_handler",
		importer: () => import("./page-data-D1intiHu.mjs")
	},
	"78c5e5b135f5a975719c39a24fa44a123bc6c1bb09c3d5c3041b661294590208": {
		functionName: "getSpotifyData_createServerFn_handler",
		importer: () => import("./spotify-BN1uf1pE.mjs")
	},
	"82c2b128e2c0488f11571d1a0cc4aed1cceba763408ece7966a556724be5f692": {
		functionName: "getGalleryData_createServerFn_handler",
		importer: () => import("./gallery-XpSZRyK8.mjs")
	},
	"aee85d5a0d58071f3fc30e793d1f8b5b1e59bd2b30d23931a84c0c92665dc12b": {
		functionName: "getVisitorCount_createServerFn_handler",
		importer: () => import("./visitor-CX3F3OKg.mjs")
	},
	"e5413d5cb26ba03b30c3f6fcc21d266268fd90af35bf0750ed51c1646b09aec6": {
		functionName: "sendContactForm_createServerFn_handler",
		importer: () => import("./contact-Bn6lFx8L.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CWJQsHNl.mjs"),
		import("./start-kSVDHRoO.mjs"),
		import("./empty-plugin-adapters-MH57YjnL.mjs")
	]);
	return {
		routerEntry,
		startEntry,
