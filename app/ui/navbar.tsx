  ...
  return (
    <animated.div
      className={`relative bg-gradient-to-r ${
        darkMode
          ? `from-indigo-800 via-pink-900 to-purple-800`
    ...
    >
      <div className="flex items-center mb-4 p-6 text-2xl">
        ...
        <div className={`flex md:hidden w-full justify-between items-center `}>
          ...
          {isDropdownOpen && (
            <div
              className={`absolute top-full right-0 mt-2 py-2 w-48 ${
                darkMode
            ...
            >
              <Link
                ...
                className={`block px-4 py-2 text-sm ${
                  darkMode ? `text-gray-white` : `text-gray-700`
                }  hover:bg-gray-100`}
              >
                CV
              </Link>
              ...
              <button onClick={toggleDarkMode}>
                {darkMode ? (
                  <p className="text-white px-4 py-2 text-sm">Lightmode</p>
                ) : (
                  <p className="text-gray-700 px-4 py-2 text-sm">Darkmode</p>
                )}
              </button>
            </div>
          )}
